...
export class UniversalForm implements UIFormSession{
    ...
    switch (JSON.parse(actionContext._actionLocalStrings.form).template_id){
        ...
        this.renderService.loadComponent('non_modal_icon', {
    ...
    onError(payload: object): void {
        // error,TODO logear el error para fines de debug y auditoria 
    }
